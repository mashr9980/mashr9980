...
**Senior Full Stack AI Engineer**, My Medical Records.ai
...
Led ML engineers building LLM systems on Runpod GPUs using Ollama and Qwen-2.5:7B. Built an AI powered automated call center with real time STT, RAG, and TTS over WebSockets. Fine tuned ASR pipelines on OpenAI Whisper processing hundreds of daily queries in production.

**Artificial Intelligence Engineer**, Hosting Controller Inc
*Sep 2023 to Jan 2025, Islamabad, Pakistan*
Deployed ML models on AWS via TensorFlow and PyTorch, served through REST and GraphQL APIs in Docker. Built full stack AI applications with Python backends and React and Flutter frontends. Set up MLOps pipelines for monitoring and retraining, cutting manual effort by half.

**Visiting Lecturer**, National University of Computer and Emerging Sciences (FAST-NUCES)
*Aug 2022 to Jan 2023, Islamabad, Pakistan*
Instructor for Object Oriented Programming and Machine Learning courses.

**Full Stack Engineer**, My Impact Meter
*Mar 2021 to Jul 2022, Lahore, Pakistan*
Built and maintained full stack web applications using modern JavaScript frameworks with responsive, performant UIs. Developed RESTful APIs and backend services for social impact data collection and reporting. Collaborated with cross functional teams to translate business requirements into scalable technical solutions.

**Frontend Developer**, Hexa Devs
*Dec 2017 to Feb 2019, Lahore, Pakistan, Remote*
Frontend development across multiple client projects.
...
*Aug 2021 to Jun 2023, Grade A*
Thesis: Multi Modal Toxic Span Detection for Low Resource Languages using VGG-19, OpenSMILE, and XLM-RoBERTa with late fusion.

**Bachelor of Science in Computer Science**
COMSATS University Islamabad
*Feb 2017 to Jan 2021*
Final Year Project: Urdu Voice Command Recognition System, a 44 class classification using MFCC, mel spectrograms, and deep learning.

---

## Featured Projects

A snapshot of recent work. Full list available on my [repositories](https://github.com/mashr9980?tab=repositories) page.

### AI Agents and LLM Applications
- [Smart-HR-agent-AI](https://github.com/mashr9980/Smart-HR-agent-AI) and [auto_HR](https://github.com/mashr9980/auto_HR), AI agents that automate HR workflows end to end
- [legal-compliance-checker-AI](https://github.com/mashr9980/legal-compliance-checker-AI), LLM powered legal and compliance document analysis
- [smart-bid-ai](https://github.com/mashr9980/smart-bid-ai), AI assistant for bidding and proposal generation
- [finance-agent-gl](https://github.com/mashr9980/finance-agent-gl) and [sage-x3-bot](https://github.com/mashr9980/sage-x3-bot), agents for finance, GL, and ERP systems
- [vlad_ai_chatbot](https://github.com/mashr9980/vlad_ai_chatbot) and [retell-ai-demo](https://github.com/mashr9980/retell-ai-demo), conversational AI and voice bots
- [eth-exploit-ai](https://github.com/mashr9980/eth-exploit-ai), AI assisted smart contract exploit research

### RAG and Knowledge Systems
- [FUSIO-RAG](https://github.com/mashr9980/FUSIO-RAG), [ragGraph](https://github.com/mashr9980/ragGraph), and [reves-rag](https://github.com/mashr9980/reves-rag), RAG architectures from baseline to graph based
- [stock_rag](https://github.com/mashr9980/stock_rag), retrieval augmented stock analysis
- [knowledge-base-chatbot](https://github.com/mashr9980/knowledge-base-chatbot) and [ESAP_knowledge_base](https://github.com/mashr9980/ESAP_knowledge_base), KB chatbots over private documents
- [prompt_to_sql](https://github.com/mashr9980/prompt_to_sql) and [prompt-to-visualization](https://github.com/mashr9980/prompt-to-visualization), natural language to SQL and charts
- [data-analysis-llama](https://github.com/mashr9980/data-analysis-llama), LLM driven data analysis with Llama

### NLP for Urdu and Low Resource Languages
- [urdu-toxic-span-detection](https://github.com/mashr9980/urdu-toxic-span-detection), multi modal toxic span detection from Master's thesis
- [Urdu-Poetry-Generation-NLP](https://github.com/mashr9980/Urdu-Poetry-Generation-NLP), generative Urdu poetry
- [Roman-Urdu-Spell-Correction-NLP](https://github.com/mashr9980/Roman-Urdu-Spell-Correction-NLP), Roman Urdu spell correction
- [Seq-to-Seq-Neural-Abstractive-Urdu-Text-Summarization-using-Pre-Trained-Models](https://github.com/mashr9980/Seq-to-Seq-Neural-Abstractive-Urdu-Text-Summarization-using-Pre-Trained-Models), seq2seq Urdu summarization

### Computer Vision and Deep Learning
- [objectDetectionUsingYOLOV8](https://github.com/mashr9980/objectDetectionUsingYOLOV8), YOLOv8 object detection
- [Medical-imaging-classification-with-streamletcloud](https://github.com/mashr9980/Medical-imaging-classification-with-streamletcloud), medical image classification on Streamlit Cloud
- [Multi-Layered-Neural-Network-for-Regression](https://github.com/mashr9980/Multi-Layered-Neural-Network-for-Regression), deep neural network built from scratch

### Full Stack and Mobile Products
- [VoyageVisa](https://github.com/mashr9980/VoyageVisa), visa and travel platform
- [speechpal](https://github.com/mashr9980/speechpal) and [voxsonus](https://github.com/mashr9980/voxsonus), speech and voice products
- [next-room](https://github.com/mashr9980/next-room), Next.js application
- [alplaar_doctor](https://github.com/mashr9980/alplaar_doctor), [impactor_health](https://github.com/mashr9980/impactor_health), and [tailor_app](https://github.com/mashr9980/tailor_app), Flutter mobile applications

### Networking and VPN Infrastructure
- [vpn-backend](https://github.com/mashr9980/vpn-backend), [shadowsocks_backend](https://github.com/mashr9980/shadowsocks_backend), and [volnexvpn_admin](https://github.com/mashr9980/volnexvpn_admin), VPN admin panels and backends
...
<p align="left">
  ...
  <a href="https://huggingface.co/" target="_blank"><img src="https://img.shields.io/badge/-Hugging%20Face-FFD21E?style=flat-square&logo=huggingface&logoColor=black" alt="Hugging Face" height="40"/></a>
  <a href="https://openai.com/" target="_blank"><img src="https://img.shields.io/badge/-OpenAI-412991?style=flat-square&logo=openai&logoColor=white" alt="OpenAI" height="40"/></a>
  <a href="https://www.langchain.com/" target="_blank"><img src="https://img.shields.io/badge/-LangChain-1C3C3C?style=flat-square&logo=langchain&logoColor=white" alt="LangChain" height="40"/></a>
  ...
  <a href="https://seaborn.pydata.org/" target="_blank"><img src="https://img.shields.io/badge/-Seaborn-4C72B0?style=flat-square&logo=python&logoColor=white" alt="Seaborn" height="40"/></a>
...
<p align="left">
  ...
  <a href="https://www.asp.net" target="_blank"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/dotnetcore/dotnetcore-original.svg" alt="ASP.NET Core" width="40" height="40"/></a>
</p>
...
<p align="left">
  ...
  <a href="https://www.pinecone.io" target="_blank"><img src="https://img.shields.io/badge/-Pinecone-000000?style=flat-square&logoColor=white" alt="Pinecone" height="40"/></a>
</p>
